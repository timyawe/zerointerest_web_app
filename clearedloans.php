<html>
		...
		<!-- Begining of header section -->
			...
			<!-- Begining of sidebar navigation -->
				...
				<ul class="side-bar">
					...
					<li class="side-list"><a class="active-sidebar-link" href="#">Cleared Loans</a></li>
	...
	<div id="main_content_table">
			...
			//select data
			$sql = "SELECT * FROM `Cleared Loans`";
			$result = mysqli_query($conn, $sql);
			
			if (mysqli_num_rows($result) > 0){
$table_header =<<<EOD
		<h1 class='table_heading'>Cleared Loans <input type=text id="search_field" placeholder="Search by name...">
		...
		<table id="this_table" border="1" style="margin-top:19px;">
			<tr>
				...
				<th>PRINCIPAL</th>
				<th>INTEREST RATE</th>
				<th>FINAL PRINCIPAL AND INTEREST</th>
				<th>COMMENT</th>
				<th>STATUS</th>
				<th>AMOUNT PAID</th>
				<th>DATE CLEARED</th>
			...
			<td></td>
			<td>
				<input type="date" placeholder="Choose date..." style="width: 115px"/>
			</td>
			<td></td>
		</tr>
EOD;
echo $table_header;
			...
			echo 	"<td>".date("d/m/Y", strtotime($row['DATE_CLEARED']))."</td>";
...
echo "</div>";
		...
		die("No Records to display");
			...
			<div id="footer">
				<p> Today is my lucky day <?php echo date("d/m/Y"); ?> </p>
			</div>
		</body>
